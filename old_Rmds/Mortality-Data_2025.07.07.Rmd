...
df.mort <- full_join(df.mo %>% mutate(SEQN=as.character(SEQN)),mort.table %>% mutate(SEQN=as.character(seqn)),by=join_by(SEQN==SEQN,Year==Year))
```
...
ggsave(plot=plt.km.05.16.actual + 
               ...
               theme.1 + coord_cartesian(xlim = c(0, 200)),filename="~/Dropbox/NHANES manuscript/figures/KM-2005-2016.bmp",width=7,height=5,units=c("in"))
...
ggsave(plot = g2,filename = "~/Dropbox/NHANES manuscript/figures/Surv-DMDx-cause.png",width=7,height=7,units="in")
```
...
#ggsave(plot=km.grid,filename="~/Dropbox/NHANES manuscript/figures/KM-test-train.bmp",units=c("in"))
