...
df.stats.table.Few <- df.stats.table %>% filter(Stat=="Threshold" | Stat=="Specificity" | Stat=="Sensitivity" | Stat=="AUROC") %>% relocate(Type,Stat,A1c.Fixed,FPG.Fixed,A1c,A1c,FPG,`FPG-A1c`,FIB4,NonFasting,Min,Full) %>% select(Type,Stat,A1c.Fixed,FPG.Fixed,A1c,A1c,FPG,NonFasting,Min) 
