...
save(office_noogtt,file="NHANES-office-2005-2016-noOGTT-layered_all_2025.08.29-Binary.Rda")
```
...
save(df.mo3,file="=NHANES-df.mo3_noogtt.Rda")
...
ggsave(plot = g1,filename = "Surv-DM-cause.png",width=7,height=7,units="in")
