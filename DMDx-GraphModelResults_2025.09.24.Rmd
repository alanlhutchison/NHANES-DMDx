...
ggsave(plot=plt.shap.lines.full,filename="Shap-lines-Full.bmp",width=7,height=7,units = c("in"))
...
ggsave(plot=plt.shap.summ.full,filename="Shap-Summ-Full.bmp",width=7,height=7,units = c("in"))
...
ggsave(plot=plt.shap.lines.soc,filename="Shap-lines-Soc.bmp",width=7,height=7,units = c("in"))
...
ggsave(plot=plt.shap.summ.soc,filename="Shap-Summ-Soc.bmp",width=7,height=7,units = c("in"))
...
ggsave(plot=plt.shap.lines.soc.fast,filename="Shap-lines-Soc.Fast.bmp",width=7,height=7,units = c("in"))
...
ggsave(plot=plt.shap.summ.soc.fast,filename="Shap-Summ-Soc.Fast.bmp",width=7,height=7,units = c("in"))
...
ggsave(plot=g,filename="Shap.Full.AB.bmp",width = 7,height = 7, units = "in")
...
load("NHANES-df.mo3_noogtt.Rda") # loads df.mo3
...
ggsave(plot=plt.cohort.boxplots,file='Cohort-Boxplots.bmp')
```
...
plt.cohorts %>% ggsave(file="Cohort-6.bmp",height=10,width=7,units=c("in")); plot(plt.cohorts)
...
plt.egfr.only %>% ggsave(file="A1c-2hG-eGFR-only.bmp",height=10,width=7,units=c("in"))
...
ggsave(plt.calibration.quantile,file="Quantile-calibration-Pred.SOC.Fasting.bmp")
...
ggsave(file='Calibration_cohorts.bmp',plot=plt.calibration.cohorts)
...
grid.arrange(nrow=4,heights=c(4,1,4,1),
            ...
            arrangeGrob(ncol=2,
             ...
             legend.2) %>% suppressWarnings() %>% ggsave(file="ROC-DCA-figure-4.bmp")
...
grid.arrange(nrow=3,heights=c(4,1,1.2),
             ...
             ),top="Diagnosis of Diabetes") %>% suppressWarnings() %>% ggsave(file="ROC-DCA-figure-AB.bmp")
...
grid.arrange(nrow=3,heights=c(5,1.5,3),
             ...
             )) %>% suppressWarnings() %>% ggsave(file="ROC-DCA-figure-AB-Few.bmp")
