...
file.xgb_tuned.full <- paste0(dir.string,"NHANES-training-XGBOOST_xgb_tuned_wIns_MIN_",filter.string,"_2025.02.06.Rda")
file.office.train <- paste0(dir.string,"NHANES-office-train-layered_wIns_MIN_",filter.string,"_2025.02.06.Rda")
file.office.test <- paste0(dir.string,"NHANES-office-test-layered_wIns_MIN_",filter.string,"_2025.02.06.Rda")
file.list.models <- paste0(dir.string,"NHANES-A1c-wIns_MIN_",filter.string,"-All-xgb.models")


file.ROCs=paste0(dir.string,"NHANES-A1c-wIns_MIN_",filter.string,"-All_ROCs.bmp" )
file.importance.plots = paste0(dir.string,"NHANES-A1c-wIns_MIN_",filter.string,"-ImportancePlots.bmp" )
file.dca.all = paste0(dir.string,"NHANES-A1c-wIns_MIN_",filter.string,"-DCA-all.bmp" )
file.dca.fib4 = paste0(dir.string,"NHANES-A1c-wIns_MIN_",filter.string,"-DCA_FIB4.bmp" )

file.dca.min = paste0(dir.string,"NHANES-A1c-wIns_MIN_",filter.string,"-DCA_min-set.bmp" )
...
#file.xgb_tuned.full <- "~/Documents/NHANES15-16/NHANES-training-XGBOOST_xgb_tuned.29_2025.02.06.Rda"
...
df.small %>% mutate(Year.2015 = ifelse(Year > 2013,"2015-2016","2005-2014")) %>% 
  getDescriptionStatsBy(by=Year.2015,
#`Fasting Glucose Plasma&dagger;`=fpg,				
VAR.MIN.2,add_total_col = FALSE,) %>% 
  addHtmlTableStyle(pos.caption = "bottom") %>% 
  htmlTable(caption  = "Basic descriptive statistics from the NHANES dataset",
            tfoot = "&dagger; mg/dL")
...
### MIN MODEL
## Can put which ever VAR.MIN.2 vs VAR.MIN.3
VAR.MIN.3 = c('fpg','a1c')
office_train.MIN <- office_train %>% select(all_of(c(VAR.MIN.3 )))

office_train.makeX <- makeX(office_train.MIN)
dtrain <- xgb.DMatrix(data = office_train.makeX, label = label.train)

office_test.MIN <- office_test %>% select(all_of(c(VAR.MIN.3 )))
...
file.office.train <- '~/Documents/NHANES15-16/NHANES-office-train-layered_2025.02.09.Rda'
save(office_train,file=file.office.train)

### This is a Rda of the office_test data frame 

file.office.test <- '~/Documents/NHANES15-16/NHANES-office-test-layered_2024.02.09.Rda'
...
file.list.models <- "~/Documents/NHANES15-16/NHANES-A1c-All-xgb_2025.02.09.models"
